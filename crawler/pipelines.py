...
class mongo_storage(object):
    ...
    def process_item(self,item,spider):
	    ...
	    f2=open(PROJECT_PATH+"/data/videos/2013-04-05/youku_video.txt",'a')
            f2.write("<title>")
	    ...
	    f1=open(PROJECT_PATH+"/data/news/rank/2013-04-05/sina_rank.txt",'a')
	    f1.write("<name>")
        ...
        #print dict(item)
            f4=open(PROJECT_PATH+"/data/news/sina/2013-04-05/"+item['title']+".txt",'w')
	    ...
	    #f4.write("\n<video_path>")
            #f4.write(str(item['video_link']))
            #f4.write("\n<video_tag>")
            #f4.write(str(item['video_tag'].encode('utf-8')))
            #f4.write("\n<video_source>")
            #f4.write(str(item['video_source'].encode('utf-8')))
            f4.write("\n<image_path>")
        ...
        #print dict(item)
            f3=open(PROJECT_PATH+"/data/news/sohu/2013-04-05/"+item['title']+".txt",'w')
            item['content'] = re.sub(ur'<[^>]*>','\n',re.sub(ur'\]\]>','',item['content']))
            f3.write("<title>")
	    ...
	    #f3.write("\n<source>")
            ...
            #f.write(str(item['image_link']))
	    f3.write("\n<video_path>")
            f3.write(str(item['video_link']))
            f3.write("\n<video_tag>")
            f3.write(str(item['video_tag'].encode('utf-8')))
            f3.write("\n<image_path>")
        ...
        #print dict(item)
            f=open(PROJECT_PATH+"/data/news/tencent/2013-04-05/"+item['title']+".txt",'w')
	    item['content'] = re.sub(ur'<[^>]*>','\n',re.sub(ur'\]\]>','',item['content']))
	    f.write("<title>")
	    ...
	    f.write("\n<video_tag>")
            f.write(str(item['video_tag']))
	    f.write("\n<video_source>")
            f.write(str(item['video_source']))
            f.close()
